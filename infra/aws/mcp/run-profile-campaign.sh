...
SUBNET="${SUBNET:-subnet-0e8ca449fad988c21}"
SERVER_SG="${SERVER_SG:-sg-0e5f6972a6d72dd07}"
KEY="${KEY:-continuum-bench}"
...
mkdir -p "$LOCAL_DEST"
for f in bm-pls0-sqlite-embedded-${PROFILE}.json bm-pls1-sqlite-embedded-${PROFILE}.json \
