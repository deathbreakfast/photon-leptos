...
pub enum Command {
    ...
    Run {
        ...
        /// Fanout mode on the bench server: `per_subscribe` or `broadcast_hub`.
        #[arg(long)]
        ws_mode: Option<String>,
        /// Key-group cardinality for BM-PLS5 (default: sweep).
        #[arg(long)]
        key_groups: Option<u32>,
    },
    ...
    Matrix {
        ...
        #[arg(long)]
        skip_existing: bool,
        /// Fanout mode applied before each experiment in the slice.
        #[arg(long)]
        ws_mode: Option<String>,
    },
