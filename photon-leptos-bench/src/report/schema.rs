...
pub struct BenchReport {
    ...
    /// Last PASS N when no FAIL was observed (incomplete knee search).
    #[serde(skip_serializing_if = "Option::is_none")]
    pub max_pass_connection_count: Option<u32>,
    /// `"observed"` when a FAIL followed a PASS; `"lower_bound"` when search hit max without FAIL.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub knee_kind: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub ws_fanout_mode: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub key_group_count: Option<u32>,
    #[serde(skip_serializing_if = "Option::is_none")]
