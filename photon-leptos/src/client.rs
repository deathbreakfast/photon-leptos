//! Client-side synced resource and WebSocket lifecycle.
//!
//! Uses `leptos_use::use_websocket` for connection management (reconnect,
//! cleanup, protocol resolution) so we don't have to hand-roll it.
...
/// the `use_<fn_name>()` hook generated by `#[photon::synced]` instead.
